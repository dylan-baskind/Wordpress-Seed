...
function mb_scripts() {
	...
	if ( !is_admin() ) {
		...
		wp_enqueue_script( 'customplugins', get_template_directory_uri() . '/Assets/Built/Vendor/vendors.min.js', array('jquery'), NULL, true );
		wp_enqueue_script( 'customscripts', get_template_directory_uri() . '/Assets/Built/Scripts/main.min.js', array('jquery'), NULL, true );
	}
}
